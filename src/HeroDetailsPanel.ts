class HeroDetailsPanel extends egret.DisplayObjectContainer{
    ...
    private textInit(){
        for (var e of this.hero[0].equipments) {
            var tf: egret.TextField = PropertiesDisplayUtils.getAllProperties(e.properties);
            var jewll:Jewll[]=e.jewlls;
    ...
    private iconInit(){
        var w1:egret.Bitmap=new egret.Bitmap();
        ...
        w1.addEventListener(egret.TouchEvent.TOUCH_TAP,(e:egret.TouchEvent)=>{
            this.desc.text=this.text[0].text;
        },this);
        this.icon.push(w1);
        this.addChild(w1);

        var w2:egret.Bitmap=new egret.Bitmap();
        w2.x=150;
        w2.y=0;
        w2.width=108;
        w2.height=150;
        ...
        w2.addEventListener(egret.TouchEvent.TOUCH_TAP,(e:egret.TouchEvent)=>{
            this.desc.text=this.text[1].text;
        },this);
        this.icon.push(w2);
        this.addChild(w2);

        var w3:egret.Bitmap=new egret.Bitmap();
        w3.x=300;
        w3.y=0;
        w3.width=108;
        w3.height=150;
        ...
        w3.addEventListener(egret.TouchEvent.TOUCH_TAP,(e:egret.TouchEvent)=>{
            this.desc.text=this.text[2].text;
        },this);
        this.icon.push(w3);
        this.addChild(w3);

        var w4:egret.Bitmap=new egret.Bitmap();
        w4.x=0;
        w4.y=400;
        w4.width=108;
        w4.height=150;
        ...
        w4.addEventListener(egret.TouchEvent.TOUCH_TAP,(e:egret.TouchEvent)=>{
            this.desc.text=this.text[3].text;
        },this);
        this.icon.push(w4);
        this.addChild(w4);
    }
